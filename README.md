...
A range may be generated by creating an instance of `MENoteRange`, passing a chord symbol as argument. Chord symbol must be of type `String`:
...
```supercollider
~range.notes; // [a MENote, a MENote, a MENote, a MENote, ...]
```
